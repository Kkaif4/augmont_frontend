...
@Component({
  ...
  standalone: true,
  imports: [MatButtonModule, MatIconModule, MatProgressBarModule, MatDividerModule],
  template: `
    <div class="page-header">
      <h1 class="page-title">Bulk Upload</h1>
    </div>

    <div class="content-card" style="padding: 32px; max-width: 600px;">
      <!-- Instructions -->
      ...
      <button
        ...
        style="width: 100%; margin-top: 24px; height: 44px;"
